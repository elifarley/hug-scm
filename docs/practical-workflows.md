...
hug cmv 3 feature/small-enhancement --new
...
**Pro tip:** The `-u` flag is incredibly powerful - it automatically figures out how many commits to move by comparing with the upstream branch.
...
**Key Differences:**
- **`hug ccp`** (cherry-pick): *Copies* commits to your current branch. Original commits stay where they are. Great for sharing specific changes across branches.
